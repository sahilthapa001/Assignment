...
import sahilStyles from "../../styles";
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className={`${sahilStyles.noramlFlex} justify-between`}>
              <div className={`${sahilStyles.noramlFlex}`}>
                <input
                  checked={rememberMe}
                  onChange={(e) => {
            ...
            <div className={`${sahilStyles.noramlFlex} w-full`}>
